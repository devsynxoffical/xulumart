...
<?php echo $__env->make('layouts.laramart.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<body style="background-color: var(--brand-body-bg-2, #FDFDFD) !important; color: var(--brand-text-dark, #1B1B1B);">
    <?php
        $business = App\Models\Setting::find(1);
    ?>
    <?php echo $__env->make('layouts.laramart.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->make('layouts.laramart.canvases', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->yieldContent('content'); ?>

    <?php echo $__env->make('layouts.laramart.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    (function () {
        ...
        document.getElementById('xmLeadForm').addEventListener('submit', function (e) {
            ...
            fetch('<?php echo e(route("popup.subscribe")); ?>', {
                method: 'POST',
                headers: {
    ...
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/vendor/jquery-3.4.1.min.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/vendor/jquery-migrate-3.1.0.min.js"></script>
    ...
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/slick.min.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/mo.min.js"></script>
    ...
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/imagesloaded.pkgd.min.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/isotope.pkgd.min.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/jquery.matchHeight-min.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/ion.rangeSlider.min.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/photoswipe.min.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/photoswipe-ui-default.min.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/jquery.zoom.min.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/ResizeSensor.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/jquery.sticky-sidebar.min.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/product360.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/jquery.magnific-popup.min.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/jquery.scrollUp.min.js"></script>
    <script src="<?php echo e(asset('frontend/assets')); ?>/js/plugins/scrollax.min.js"></script>

    <!-- Use the minified version files listed below for better performance and remove the files listed above -->
    <!-- <script src="<?php echo e(asset('frontend/assets')); ?>/js/vendor/vendor.min.js"></script>
    ...
    <div class="icon-bar">
        <a class="whatsapp" title="WhatsApp Us" target="_blank"
            href="https://api.WhatsApp.com/send?phone=<?php echo e($setting->phone); ?>&amp;text=Hello!"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.add-to-wishlist').on('click', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('wishlist.add.lara', ':id')); ?>'.replace(':id',
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: '<?php echo e(route('wishlist.add.count')); ?>',
...
</html><?php /**PATH /Users/hassan/Downloads/xulumart/resources/views/layouts/laramart/master.blade.php ENDPATH**/ ?>
...
<div class="xm-header-main d-none d-xl-block">
    <div class="container" style="max-width:1320px;">
        <div class="xm-row">
            <a href="<?php echo e(url('/')); ?>" class="xm-logo">
                <span class="xm-logo-chip">
                    <img src="<?php echo e(\App\Helpers\Media::url('website', optional($business)->logo)); ?>" alt="" onerror="this.style.display='none'">
                </span>
                <span class="xm-logo-text"><?php echo e(optional($business)->name ?? 'XuLu Mart'); ?></span>
            </a>

            <div class="xm-search">
                <form method="get" action="<?php echo e(route('search.result')); ?>" autocomplete="off">
            ...
            <div class="xm-tools">
                <a class="xm-tool" href="<?php echo e(Auth::check() ? url('my-account') : route('login')); ?>">
                    <i class="far fa-user"></i>
                    <span class="xm-tool-text">
                        <span><?php echo e(Auth::check() ? 'Hello' : 'Sign in'); ?></span>
                        <b>Account</b>
                    </span>
                </a>
                ...
                <a class="xm-tool offcanvas-toggle" href="#offcanvas-cart">
                    <span class="xm-badge cart-count"><?php echo e(Cart::count()); ?></span>
                    <i class="fas fa-shopping-cart"></i>
                    <span class="xm-tool-text"><b>Cart</b></span>
                </a>
                <a class="xm-wholesale" href="<?php echo e($wholesale_link); ?>" target="_blank" rel="noopener">
    ...
    <div class="container" style="max-width:1320px;">
        <div class="xm-nav-inner">
                ...
                <div class="xm-cat-dropdown">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="xm-cat-item">
                            <a href="<?php echo e(route('category.products', [$category->id, Str::slug($category->title)])); ?>">
                                <?php echo e($category->title); ?>

                                <?php if($category->child->count()): ?> <i class="fa fa-angle-right"></i> <?php endif; ?>
                            </a>
                            <?php if($category->child->count()): ?>
                                <div class="xm-cat-sub">
                                    <?php $__currentLoopData = $category->child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(route('category.products', [$sub->id, Str::slug($sub->title)])); ?>"><?php echo e($sub->title); ?></a>
            ...
            <ul class="xm-nav-links">
                ...
                <li><a href="<?php echo e(route('products')); ?>">Shop</a></li>
                <li><a href="<?php echo e(route('flashSale')); ?>">Flash Sale</a></li>

                <?php $__currentLoopData = $primaryNav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <a href="<?php echo e(route('category.products', [$category->id, Str::slug($category->title)])); ?>">
                            <?php echo e($category->title); ?>

                            <?php if($category->child->count()): ?> <i class="fa fa-angle-down"></i> <?php endif; ?>
                        </a>
                        <?php if($category->child->count()): ?>
                            <div class="xm-drop">
                                <?php $__currentLoopData = $category->child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <li>
                    ...
                    <div class="xm-drop">
                        <?php $__currentLoopData = $moreNav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('category.products', [$category->id, Str::slug($category->title)])); ?>"><?php echo e($category->title); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(!empty($business->phone)): ?>
                <div class="xm-nav-phone">
                    <a href="tel:<?php echo e($business->phone); ?>"><i class="fa fa-phone"></i> <?php echo e($business->phone); ?></a>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<div class="xm-mobile-header d-xl-none">
    <div class="container-fluid px-3">
        ...
        <a href="<?php echo e($wholesale_link); ?>" target="_blank" rel="noopener" class="xm-mobile-wholesale">
            <i class="fab fa-whatsapp"></i> Wholesale Order / Wholesale Price
        </a>
    </div>
</div>
<?php /**PATH /Users/hassan/Downloads/xulumart/resources/views/layouts/laramart/header.blade.php ENDPATH**/ ?>
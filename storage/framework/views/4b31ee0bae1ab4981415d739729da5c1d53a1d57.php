...
<div class="site-footer-newsletter">
    <div class="container">
        <div class="nl-inner">
            ...
            <form action="<?php echo e(route('subscribe')); ?>" method="post" class="nl-form mc-form widget-subscibe2">
                <?php echo csrf_field(); ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-4">
                <?php if(optional($business)->footer_logo || optional($business)->logo): ?>
                    <img src="<?php echo e(\App\Helpers\Media::url('website', $business->footer_logo ?: $business->logo)); ?>" alt="<?php echo e(optional($business)->name ?? 'XuLu Mart'); ?> logo" style="max-width:180px;">
                <?php else: ?>
                    <div class="footer-brand-logo"><i class="fas fa-shopping-bag"></i> <?php echo e(optional($business)->name ?? 'XuLu Mart'); ?></div>
                ...
                <div class="footer-social">
                    <?php if(optional($business)->facebook): ?>
                        <a href="<?php echo e($business->facebook); ?>" target="_blank" rel="noopener" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
                    <?php endif; ?>
                    <?php if(optional($business)->instagram): ?>
                        <a href="<?php echo e($business->instagram); ?>" target="_blank" rel="noopener" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
                    <?php endif; ?>
                    <?php if(optional($business)->twitter): ?>
                        <a href="<?php echo e($business->twitter); ?>" target="_blank" rel="noopener" aria-label="Twitter"><i class="fab fa-twitter"></i></a>
                    <?php endif; ?>
                    <?php if(optional($business)->tiktok): ?>
                        <a href="<?php echo e($business->tiktok); ?>" target="_blank" rel="noopener" aria-label="TikTok"><i class="fab fa-tiktok"></i></a>
                    <?php endif; ?>
                    <?php if(optional($business)->youtube): ?>
                        <a href="<?php echo e($business->youtube); ?>" target="_blank" rel="noopener" aria-label="YouTube"><i class="fab fa-youtube"></i></a>
                    <?php endif; ?>
                    <?php if(optional($business)->linkedin): ?>
                        <a href="<?php echo e($business->linkedin); ?>" target="_blank" rel="noopener" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <ul class="footer-link-list">
                    <li><a href="<?php echo e(route('products')); ?>">New In</a></li>
                    <li><a href="<?php echo e(route('flashSale')); ?>">Best Sellers</a></li>
                    <li><a href="<?php echo e(route('offer.products')); ?>">Deals</a></li>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <ul class="footer-link-list">
                    <li><a href="<?php echo e(route('faqs.page')); ?>">FAQs</a></li>
                    <li><a href="<?php echo e(route('shipping.policy')); ?>">Shipping Policy</a></li>
                    <li><a href="<?php echo e(route('returns.refunds')); ?>">Returns &amp; Refunds</a></li>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <ul class="footer-contact-list">
                    <?php if(optional($business)->email): ?>
                        <li><i class="far fa-envelope"></i> <span><?php echo e($business->email); ?></span></li>
                    <?php endif; ?>
                    <?php if(optional($business)->phone): ?>
                        <li><i class="fas fa-phone-alt"></i> <span><?php echo e($business->phone); ?></span></li>
                    <?php endif; ?>
                    <?php if(optional($business)->address): ?>
                        <li><i class="fas fa-map-marker-alt"></i> <span><?php echo e($business->address); ?></span></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
...
<div class="site-footer-bottom">
    <div class="container">
        <p>
            &copy; <?php echo e(date('Y')); ?> <?php echo e(optional($business)->name ?? 'XuhuMart'); ?>. All rights reserved.<br>
            You are receiving this email because you subscribed to our newsletter.
            <a href="<?php echo e(route('contact')); ?>">Unsubscribe</a>
        </p>
    </div>
</div>
<!-- Modal -->
                ...
                <div class="col-lg-6 col-12 learts-mb-30">
                    <div class="product-images">
                        <div class="product-gallery-slider-quickview">
                            <div class="product-zoom" data-image="<?php echo e(asset('frontend/assets')); ?>/images/product/single/1/product-zoom-1.webp">
                                <img src="<?php echo e(asset('frontend/assets')); ?>/images/product/single/1/product-1.webp" alt="">
                            </div>
                            <div class="product-zoom" data-image="<?php echo e(asset('frontend/assets')); ?>/images/product/single/1/product-zoom-2.webp">
                                <img src="<?php echo e(asset('frontend/assets')); ?>/images/product/single/1/product-2.webp" alt="">
                            </div>
                            <div class="product-zoom" data-image="<?php echo e(asset('frontend/assets')); ?>/images/product/single/1/product-zoom-3.webp">
                                <img src="<?php echo e(asset('frontend/assets')); ?>/images/product/single/1/product-3.webp" alt="">
                            </div>
                            <div class="product-zoom" data-image="<?php echo e(asset('frontend/assets')); ?>/images/product/single/1/product-zoom-4.webp">
                                <img src="<?php echo e(asset('frontend/assets')); ?>/images/product/single/1/product-4.webp" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-12 overflow-hidden position-relative learts-mb-30">
                    <div class="product-summery customScroll">
                        ...
                        <div class="product-brands">
                            ...
                            <div class="brands">
                                <a href="#"><img src="<?php echo e(asset('frontend/assets')); ?>/images/brands/brand-3.webp" alt=""></a>
                                <a href="#"><img src="<?php echo e(asset('frontend/assets')); ?>/images/brands/brand-8.webp" alt=""></a>
                            </div>
                        </div>
...
</div><?php /**PATH /Users/hassan/Downloads/xulumart/resources/views/layouts/laramart/footer.blade.php ENDPATH**/ ?>
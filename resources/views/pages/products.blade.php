...
@section('title') {{optional($page)->meta_title}} @endsection
@section('description'){{optional($page)->meta_description}} @endsection
@section('keywords'){{optional($page)->meta_keywords}}@endsection
        ...
        <div class="section section-fluid section-padding pt-2" style="background: var(--brand-body-bg-1, #FAFAFA);">
            <div class="container">
                <div class="section-title2 text-center mb-4" data-aos="fade-up">
                    <h1 class="title title-icon-both" style="font-size:28px;font-weight:800;">All Products</h1>
                        ...
                        <div class="prodyct-tab-content1 tab-content">
                            <div class="tab-pane fade show active" id="tab-new-sale">
                                ...
                                <div class="products row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 ">
                                    @php
                                        // FIX: was Product::all() - no is_active filter (could show
                                        // draft/inactive products publicly) and no pagination (loads
                                        // the entire catalog on one request). Now filtered + paginated.

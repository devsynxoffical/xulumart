        ...
        <div class="row">
            <div class="col-lg-6 col-12 mx-auto">
                <div class="contact-form">
                    <img src="{{asset('frontend/assets/images/about/contact_us.jpg')}}" width="100%" alt="">
                    <p class="form-messege"></p>
                </div>
            </div>
            <div class="col-lg-6 col-12 mx-auto">
                <div class="section-title2 text-center ">
                    <h2 class="title mt-2">Send a message</h2>
                </div> 
                <div class="contact-form">
                    <form action="{{ route('message.query') }}" method="POST" id="contact-forms" >
                        @csrf
                        <div class="row learts-mb-n30">
                            ...
                            <div class="col-md-6 col-12 learts-mb-30"><input type="text" placeholder="Your Phone *" name="phone"></div>
                            <div class="col-md-6 col-12 learts-mb-30"><input type="text" placeholder="Subject" name="subject"></div>
...
<div class="section section-padding">
    <div class="container">
        ...
        <div class="row learts-mb-n30 bg-white pt-3 rounded">
            <div class="col-lg-4 col-md-6 col-12 learts-mb-30">
                <div class="contact-info">
                    <h4 class="title">ADDRESS</h4>
                    <span class="info"><i class="icon fas fa-map-marker-alt" style="color: green !important;"></i> 1800 Abbot Kinney Blvd. Unit D & E Venice</span>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12 learts-mb-30">
                <div class="contact-info">
                    <h4 class="title">CONTACT</h4>
                    <span class="info"><i class="icon fas fa-phone-alt" style="color: green !important;"></i> Mobile: (+88) - 1990 - 6886 <br> Hotline: 1800 – 1102</span>
                    <span class="info"><i class="icon far fa-envelope" style="color: green !important;"></i> Mail: <a href="#">contact@leartsstore.com</a></span>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12 learts-mb-30">
                <div class="contact-info">
                    <h4 class="title"> HOUR OF OPERATION</h4>
                    <span class="info"><i class="icon far fa-clock" style="color: green !important;"></i> Monday - Friday : 09:00 – 20:00 <br> Sunday & Saturday: 10:30 – 22:00</span>
                </div>
            </div>
        </div>

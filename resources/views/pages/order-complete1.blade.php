                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <table class="order-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                {{ optional($product->product)->title ?? 'Product no longer available' }}&nbsp;<strong>x {{ $product->qty }} = </strong>
                                            </td>
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="order-table">
                                    <thead>
                                        <tr>
                                            <th class="text-dark"> Order Details </th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>  </td>
                                            <td style="text-align: right">{{ $order->status->title }}</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                Date 
                                            ...
                                            <td>  </td>
                                            <td style="text-align: right">{{\Carbon\Carbon::parse($order->created_at)->format('d M, Y')}}</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                Total
                                            ...
                                            <td>  </td>
                                            <td style="text-align: right">{{ env('CURRENCY') }} {{ $order->price + $order->shipping_charge }} {{ env('UAE_CURRENCY') }}</td>
                                        </tr>
                                    <tfoot>

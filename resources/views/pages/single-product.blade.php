    ...
    <div class="page-content">
        <div class="container">
            <div class="row gutter-lg">
                            ...
                            <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                ...
                                <div class="product-bm-wrapper">
                                    <figure class="brand">
                                        ...
                                        <a href="{{ route('brand.products', [$product->brand->id, Str::slug($product->brand->title)]) }}"><img src="{{ asset('images/brand/' . $product->brand->image) }}" alt="Brand" width="80" height="48" /></a>
                                        @endif
                                    </figure>
                                ...
                                <div class="fix-bottom product-sticky-content">
                                    <div class="product-form container">
                                        ...
                                        <a onclick="addToWishlist({{ $product->id }})" class="btn-product-icon w-icon-heart mx-2" title="Add to Wishlist"><span></span></a>
                                    </div>
                                </div>
                ...
                <!-- End of Main Content -->
                <aside class="sidebar product-sidebar sidebar-fixed right-sidebar sticky-sidebar-wrapper pt-2" style="border: 2px solid #F7B466; border-radius: 10px;">

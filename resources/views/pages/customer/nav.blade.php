<div class="card">
  ...
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item  {{url('/my-orders') == url()->current() ? 'active' : '' }}"><a href="{{ route('customer.orders') }}">Orders</a></li>
    <li class="list-group-item {{url('/my-wishlist') == url()->current() ? 'active' : '' }} "><a href="{{ route('customer.wishlist') }}">Wishlist</a></li>
    {{-- <li class="list-group-item"><a href="{{ route('customer.wallet') }}">My Wallet</a></li> --}}
    <li class="list-group-item {{url('/my-account') == url()->current() ? 'active' : '' }}  "><a href="{{ route('customer.account') }}">Account details</a></li>

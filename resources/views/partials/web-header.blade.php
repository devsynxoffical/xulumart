...
<header class="header">
    ...
    <div class="header-middle" style="padding-top: 5px; padding-bottom: 5px;">
        <div class="container">
            <div class="header-left mr-md-4">
                ...
                <a href="{{ route('index') }}" class="logo ml-lg-0">
                    <img src="{{ asset('images/website/'.$business->logo) }}" style="width: 200px !important; height: 80px !important;" alt="logo" width="200" height="80" />
                </a>
            ...
            <div class="header-right ml-4">
                <div class="header-call d-xs-show d-lg-flex align-items-center">
                    ...
                    <div class="call-info d-lg-show">
                        <h4 class="chat font-weight-normal font-size-md text-normal ls-normal text-light mb-0">
                            <a href="tel:{{ $business->phone }}" class="text-capitalize">Live Chat</a> or :</h4>
                        <a href="tel:{{ $business->phone }}" class="phone-number font-weight-bolder ls-50">{{ $business->phone }}</a>
                    </div>
                </div>
                ...
                <a class="compare label-down link d-lg-none mr-0" href="tel:{{ $business->phone }}">
                    <div class="bottom_navigation_custom">
                        <i class="w-icon-call" style="font-size: 2.5rem !important;"></i>
                        <span class="compare-label">Call Now</span>
                    </div>
                </a>

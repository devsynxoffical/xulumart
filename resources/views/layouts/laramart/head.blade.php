<head>
    ...
    <title>@yield('title', ($business->name ?? 'Xulu Mart') . ' | Online Shopping')</title>
    <meta name="robots" content="index, follow" />
    <meta name="description" content="@yield('meta_description', 'Shop quality products online at ' . ($business->name ?? 'Xulu Mart') . '. Fast delivery, great prices, and a wide range of categories.')">
    <link rel="canonical" href="@yield('canonical', url()->current())" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ \App\Helpers\Media::url('website', optional($business)->favicon, 'images/website/xulumart_favicon.png') }}">

    <!-- Vendor CSS (Bootstrap & Icon Font) -->
    <link rel="stylesheet" href="{{asset('frontend/assets')}}/css/vendor/bootstrap.min.css">
    <link rel="stylesheet" href="{{asset('frontend/assets')}}/css/vendor/fontawesome.min.css">
    <link rel="stylesheet" href="{{asset('frontend/assets')}}/css/vendor/themify-icons.css">
    <link rel="stylesheet" href="{{asset('frontend/assets')}}/css/vendor/customFonts.css">
    ...
    <link rel="stylesheet" href="{{asset('frontend/assets')}}/css/plugins/photoswipe.css">
    <link rel="stylesheet" href="{{asset('frontend/assets')}}/css/plugins/photoswipe-default-skin.css">
    ...
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/brand-theme.css') }}?v={{ @filemtime(public_path('frontend/assets/css/brand-theme.css')) ?: time() }}">
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ \App\Helpers\Media::url('website', optional($business)->favicon, 'images/website/xulumart_favicon.png') }}">
